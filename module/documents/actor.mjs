...
export default class StarMercsActor extends Actor {
  ...
  async _rollTargetedAttack(weapon, target) {
    ...
    const templateData = {
      ...
      hasAccuracyMods: (result.accuracy.ewarMod > 0 || result.accuracy.readinessMod > 0 || (result.accuracy.accurateMod ?? 0) > 0 || (result.accuracy.inaccurateMod ?? 0) > 0 || (result.accuracy.disorderedMod ?? 0) !== 0 || (result.accuracy.standDownMod ?? 0) !== 0 || (result.accuracy.orderAccuracyMod ?? 0) !== 0 || (result.accuracy.areaVsInfantryMod ?? 0) !== 0),
  ...
  async _rollStandaloneAttack(weapon) {
    ...
    const templateData = {
      ...
      hasAccuracyMods: (accuracy.readinessMod > 0 || (accuracy.accurateMod ?? 0) > 0 || (accuracy.inaccurateMod ?? 0) > 0 || (accuracy.orderAccuracyMod ?? 0) !== 0 || (accuracy.areaVsInfantryMod ?? 0) !== 0),
  ...
  async rollAllAttacks() {
    ...
    for (const result of results) {
      ...
      const templateData = {
        ...
        orderAccuracyMod: result.accuracy.orderAccuracyMod ?? 0,
        areaVsInfantryMod: result.accuracy.areaVsInfantryMod ?? 0,
        hasAccuracyMods: (result.accuracy.ewarMod > 0 || result.accuracy.readinessMod > 0 || (result.accuracy.accurateMod ?? 0) > 0 || (result.accuracy.inaccurateMod ?? 0) > 0 || (result.accuracy.orderAccuracyMod ?? 0) !== 0 || (result.accuracy.areaVsInfantryMod ?? 0) !== 0),
        hitType: result.hitResult.type,
        hitLabel: HIT_LABELS[result.hitResult.type],
        isHit: result.hitResult.hit,
        isCriticalHit: result.hitResult.type === "critical_hit",
